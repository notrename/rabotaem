...
class TestOkkoPage:
    ...
    def test_open_main_page(self):
        ...
        assert self.page.open_okko(), i(f'Тест {test_name} провален\n\n')
    ...
    def test_find_element_in_dom_tree(self):
        ...
        i(f'Запускаем тест {test_name}')
        self.page.open_okko()
        assert self.page.xpath_is_present('//*[@1]/div[2]/article[2]/div/div[1]/div[2]/a/button'), i(f'Тест {test_name} провален\n\n')
        i(f'Тест {test_name} завершён\n\n')
    ...
    def test_clickable(self):
        ...
        i(f'Запускаем тест {test_name}')
        self.page.open_okko()
        assert self.page.element_is_clickable('//*[@id="root"]/div[2]//'), i(f'Тест {test_name} провален\n\n')
        i(f'Тест {test_name} завершён\n\n')
    ...
    def test_click_element(self):
        ...
        i(f'Запускаем тест {test_name}')
        self.page.open_okko()
        assert self.page.click_element('//*[@id="root"]/div[2]/v[1]/div[2]/a/button'), i(f'Тест {test_name} провален\n\n')
        i(f'Тест {test_name} завершён\n\n')
